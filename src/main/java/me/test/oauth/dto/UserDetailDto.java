...
public class UserDetailDto {
    ...
    public static UserDetailDto from(User user, ZoomUser zoomUser) {
        ...
        return UserDetailDto.builder()
                ...
                .licenseDisplayName(str(zoomUser.getLicenseInfoList().getDisplayName()))
                .licenseName(str(zoomUser.getLicenseInfoList().getName()))
                .licenseType(str(zoomUser.getLicenseInfoList().getType()))
